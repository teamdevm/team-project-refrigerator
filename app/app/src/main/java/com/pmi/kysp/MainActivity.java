...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Product p1 = new Product("123","Тест1",img,1);
        Product p2 = new Product("123","Тест2","123",13);
        Product p3 = new Product("123","Тест3","123",11);
        Product p4 = new Product("123","Тест4",img,21);
        Product p5 = new Product("123","Тест5,","123",1);
        Product p6 = new Product("123","Тест5,","123",1);
        Product p7 = new Product("123","Тест5,","123",1);
